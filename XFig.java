...
public class XFig {
	...
	public static void drawCircle(int thickness, double x, double y, double radius, XFigScale xfs, PrintStream out) {
		assert (thickness >= 1);
	...
	public static void drawFilledCircle(int thickness, int areaFill, double x, double y, double radius, XFigScale xfs,
			PrintStream out) {
		...
		out.format("1 3 0 %d 0 0 0 0 %d 0.000 1 0.0000 %.0f %.0f %.0f %.0f %.0f %.0f %.0f %.0f\n", thickness, areaFill,
				x, y, radius, radius, x, y, x, y + radius);
	}
	...
	public static void drawRectangle(int thickness, double x1, double y1, double x2, double y2, XFigScale xfs,
			PrintStream out) {
		assert (thickness >= 1);
